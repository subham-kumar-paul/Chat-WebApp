...
from chat_dj.chats.models import Message, Conversation
from chat_dj.users.api.serializers import UserSerializer
...
class MessageSerializer(serializers.Serializer):
    ...
    class Meta: 
        model = Message
        fields = ['id', 'conversation', 'from_user', 'to_user', 'content', 'timestamp', 'read']
